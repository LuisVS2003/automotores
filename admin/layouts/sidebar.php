    ...
    <ul class="sidebar-menu">
      ...
      <li class="sidebar-link">
        <a href="./consulta-dni-ajax">
          ...
          <span>Consulta DNI VarDump</span>
        </a>
      </li>
  ...
  <div class="sidebar-footer">
    <div class="user-profile">
      ...
      <div class="user-details">
        <h3 class="user-name" title="nombre de usuario"><?= $_SESSION["nombres"] ?></h3>
        <p class="user-email" title="correo"><?= $_SESSION["correo"] ?></p>
      </div>
    </div>
    ...
    <div class="user-options hidden">
      <ul class="options-list">
        ...
        <li class="option-item">
          <a href="../controllers/EmpleadoController.php?operacion=destroy">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-logout-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              <path d="M10 8v-2a2 2 0 0 1 2 -2h7a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-7a2 2 0 0 1 -2 -2v-2" />
              <path d="M15 12h-12l3 -3" />
              <path d="M6 15l-3 -3" />
            </svg>
            <span href="">Salir</span>
          </a>
        </li>
      </ul>
    </div>
...
<div id="backdrop" class="backdrop sidebar-toggle" style="z-index: 999"></div>